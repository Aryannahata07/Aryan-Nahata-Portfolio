    ...
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transition-all duration-700 group-hover:scale-105">
          ...
          <img src="/profile.jpg" alt="Profile" className="w-full h-full object-cover transition-all duration-700 group-hover:scale-110 group-hover:rotate-2" loading="lazy" />
        </div>
      </div>
    </div>
  </div>
...
const AboutPage = () => {
  ...
  const statsData = [
    { icon: Code, color: "from-[#6366f1] to-[#a855f7]", value: 10, label: "Total Projects", description: "Innovative web solutions crafted", animation: "fade-right" },
    { icon: Award, color: "from-[#a855f7] to-[#6366f1]", value: 4, label: "Certificates", description: "Professional skills validated", animation: "fade-up" },
    {
  icon: Code,
  color: "from-[#6366f1] to-[#a855f7]",
  value: 650,  
  label: "DSA Questions Solved",
  description: "Sharpening problem-solving skills",
  animation: "fade-left",
},
  ];
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold" data-aos="fade-right" data-aos-duration="1000">
              ...
              <span className="block mt-2 text-gray-200" data-aos="fade-right" data-aos-duration="1300">Aryan Nahata</span>
            </h2>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              A developer passionate about building intelligent systems, solving real-world problems through AI and machine learning, and crafting impactful web applications. I actively explore data structures, algorithms, and competitive programming to sharpen my problem-solving skills and bring clarity to complex challenges.
            </p>
            ...
            <div className="relative bg-gradient-to-br from-[#6366f1]/5 via-transparent to-[#a855f7]/5 border border-gradient-to-r border-[#6366f1]/30 rounded-2xl p-4 my-6 backdrop-blur-md shadow-2xl overflow-hidden" data-aos="fade-up" data-aos-duration="1700">
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "AI is only as powerful as the purpose behind its code."
              </blockquote>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 w-full">
              <a href="https://drive.google.com/file/d/1txudrYcV0l1dDAKH_M424J8ryhrzDiME/view?usp=sharing" className="w-full lg:w-auto">
                <button className="w-full lg:w-auto sm:px-6 py-2 sm:py-3 rounded-lg bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
