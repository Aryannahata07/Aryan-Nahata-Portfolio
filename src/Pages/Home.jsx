...
const WORDS = ["AI & ML Student", "Tech Enthusiast", "Software Engineering Enthusiast",
  "Competitive Programmer",
  "Data Structures & Algorithms Learner"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Aryannahata07" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/aryan-nahata-12b921282/" },
  { icon: Instagram, link: "https://www.instagram.com/aryann_nahata/" },
  { icon: SiLeetcode, link: "https://leetcode.com/u/aryan_nahata07/" }
];  
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Engineer. Innovator. Building the future with code and creativity.
                </p>
